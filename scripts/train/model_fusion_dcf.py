...
def parse_args():
    ...
    parser.add_argument('--max-layers', type=int, default=10, metavar='CL',
                   help='max number of cascaded layers (default: 10)')
    
    parser.add_argument('--partial-mode', action='store_true', default=False,
                   help='partial mode for large datasets (default: False)')
...
def train(args):
    ...
    lgb_predictor_params = {
        ...
        "reg_lambda": args.weight_decay,
        
        "early_stopping_rounds": args.early_stopping_rounds,
        "eval_metric": "multi_logloss"
    }

    clf = CascadeForestClassifier(use_predictor=True, predictor='lightgbm', predictor_kwargs=lgb_predictor_params, n_trees=args.trees, max_layers=args.max_layers, max_depth=args.max_depth, verbose=2, n_jobs=args.workers, random_state=args.seed, n_tolerant_rounds=args.early_stopping_rounds, partial_mode=args.partial_mode)
